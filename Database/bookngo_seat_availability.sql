...
--
-- Host: localhost    Database: bookngo
-- ------------------------------------------------------
...
CREATE TABLE `seat_availability` (
  ...
  CONSTRAINT `seat_availability_ibfk_1` FOREIGN KEY (`salon_id`) REFERENCES `salons` (`salon_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-11-03 19:51:50
